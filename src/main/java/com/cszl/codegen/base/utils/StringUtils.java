...
/**
 * create by wdq on 2021/4/12 10:36
 */
public class StringUtils {
    ...
    public static String concatByAnd(String a, String b) {
        return a.concat("And").concat(b);
    }

    public static String concatByOR(String a, String b) {
        return a.concat("Or").concat(b);
    }
